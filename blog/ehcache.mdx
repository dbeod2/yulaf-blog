...
- 직렬화된 데이터 객체를 저장하는 메모리블럭
    - ehcache3은 캐싱 데이터를 외부 메모리에 저장하기 위해서 저장 할 데이터가 serializable이 구현 되어 있어야한다.
        ...
        [https://medium.com/finda-tech/spring-로컬-캐시-라이브러리-ehcache-4b5cba8697e0](https://medium.com/finda-tech/spring-%EB%A1%9C%EC%BB%AC-%EC%BA%90%EC%8B%9C-%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC-ehcache-4b5cba8697e0)
...
관련된 설정과 테스트는 https://github.com/dbeod2/ehcache-test 깃에 올려놨다.
